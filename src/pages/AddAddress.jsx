...
const AddAddress = () => {
  ...
  return (
    <div className='mt-16 pb-16'>
        ...
        <span className='font-semibold text-indigo-500'>  Address</span></p>
            ...
            <div className='flex-1 max-w-md'>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        ...
                        />
                        <button className='w-full mt-6 bg-indigo-500 text-white py-3 hover:bg-indigo-600
                        transition cursor-pointer uppercase rounded'>
                            Save address
                        </button>
                </form>
            </div>
