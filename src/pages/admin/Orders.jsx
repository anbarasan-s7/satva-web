...
import { assets, dummyOrders } from '../../assets/img/assets';
...
const Orders = () => {
  ...
  return (
    <div className='no-scrollbar flex-1 has-[95vh] overflow-y-scroll'>
            ...
            {orders.map((order, index) => (
                <div key={index} className="flex flex-col md:items-center md:flex-row justify-between gap-5 p-5 max-w-4xl rounded-md border border-gray-300">
                    <div className="flex gap-5 max-w-80">
                        <img className="w-12 h-12 object-cover rounded-sm " src={assets.box_icon} alt="boxIcon" />
                        <div>
